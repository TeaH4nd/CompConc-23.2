...
// Monitor
class LE {
    private int leit, escr, escrEsperando; // Variável escrEsperando representa o número de escritores esperando para escrever
    ...
    public synchronized void SaiLeitor(int id) {
        this.leit--;
        if (this.leit == 0) {
            notify(); // libera escritor (caso exista escritor bloqueado)
        }
